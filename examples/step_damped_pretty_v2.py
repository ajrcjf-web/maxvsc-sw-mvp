"""
Escenarios 'damped_pretty_v2' de ejemplo usando parámetros con
oscilaciones amortiguadas visibles:
...
Uso desde la raíz del repo:
    ...
    $env:PYTHONPATH='src'; python examples/step_damped_pretty_v2.py
"""
...
def run_pq_damped_pretty_v2(repo_root: Path) -> None:
    """
    Escenario en modo PQ con paso de potencia visible.
    """
    params_path = repo_root / "examples" / "params_damped_pretty_v2.json"
    scenario_path = repo_root / "examples" / "scenario_pq_damped_pretty_v2.json"
    ...
    print("=== Escenario damped_pretty_v2: paso de potencia PQ ===")
    print(f"  t_end       = {t_end}")
...
def run_vdcq_damped_pretty_v2(repo_root: Path) -> None:
    """
    Escenario en modo VdcQ con paso de id_ref visible.
    """
    params_path = repo_root / "examples" / "params_damped_pretty_v2.json"
    scenario_path = repo_root / "examples" / "scenario_vdcq_damped_pretty_v2.json"
    ...
    print("=== Escenario damped_pretty_v2: paso de id_ref (VdcQ) ===")
    print(f"  t_end       = {t_end}")
    print(f"  t_step      = {step_time}")
...
def main():
    ...
    run_pq_damped_pretty_v2(repo_root)
    run_vdcq_damped_pretty_v2(repo_root)
