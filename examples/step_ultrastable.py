"""
Escenarios "ultraestables" de ejemplo usando parámetros muy conservadores:
...
Uso desde la raíz del repo:
    ...
    $env:PYTHONPATH='src'; python examples/step_ultrastable.py
"""
...
def run_pq_ultrastable(repo_root: Path) -> None:
    ...
    print("=== Escenario ULTRAestable: paso pequeño de potencia PQ ===")
    print(f"  t_end       = {t_end}")
...
def run_vdcq_ultrastable(repo_root: Path) -> None:
    params_path = repo_root / "examples" / "params_ultrastable.json"
    ...
    print("=== Escenario ULTRAestable: paso pequeño de id_ref (VdcQ) ===")
    print(f"  t_end       = {t_end}")
    print(f"  t_step      = {step_time}")
...
def main():
    ...
    run_pq_ultrastable(repo_root)
    run_vdcq_ultrastable(repo_root)
